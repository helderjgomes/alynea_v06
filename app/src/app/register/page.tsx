            ...
            <div className="min-h-screen flex items-center justify-center bg-[#F5F5F4]">
                <div className="w-full max-w-sm text-center">
                    <div className="bg-white rounded-2xl shadow-lg p-6">
                        ...
                        <h2 className="text-[18px] font-medium text-[#1D1D1F] mb-2">
                            Check your email
                        </h2>
        ...
        <div className="min-h-screen flex items-center justify-center bg-[#F5F5F4]">
            <div className="w-full max-w-sm">
                ...
                <div className="text-center mb-8">
                    <h1 className="text-[28px] font-semibold text-[#1D1D1F]">Alynea</h1>
                    <p className="text-[14px] text-[#86868B] mt-1">
                        Start your calm productivity journey
                    </p>
                </div>

                {/* Card */}
                <div className="bg-white rounded-2xl shadow-lg p-6">
                    <h2 className="text-[18px] font-medium text-[#1D1D1F] mb-6">
                        Create account
                    </h2>

                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            <label className="text-[12px] text-[#86868B] block mb-1.5">
                                Email
                            </label>
                            <Input
                                type="email"
                    ...
                    {/* Login Link */}
                    <p className="text-center text-[13px] text-[#86868B] mt-5">
